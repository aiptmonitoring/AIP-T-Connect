...
export default function ClassificationOfFeesPage() {
  ...
  const filtered = useMemo(() => {
    ...
    return term ? items.filter((item) => `${item.description} ${item.color_indication}`.toLowerCase().includes(term)) : items;
  },[items,query]);
